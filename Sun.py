# This is from https://stackoverflow.com/questions/19615350/calculate-sunrise-and-sunset-times-for-a-given-gps-coordinate-within-postgresql
...
class Sun:
    ...
    def calcSunTime( self, coords, isRiseTime, zenith = 90.8 ): #want 22:00 as output
